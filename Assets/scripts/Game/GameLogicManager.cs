...
public class GameLogicManager : MonoBehaviour
{
    ...
    private BallManager ball_script;

    public void handleBallCollidesBottom()
    {
        ball_script.stopBall();
        if (infoWindow != null)
            infoWindow.SetActive(true);
        else
            print("info window is null");
    }
    ...
    void Start()
    {
        // init Game Objects and scripts
        ball = GameObject.Find("Ball");
        infoWindow = transform.Find("InfoWindow").gameObject;
        ball_script = ball.GetComponent<BallManager>();
